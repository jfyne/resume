...
Python, Django, PHP, Zend Framework, Java, Advanced Javascript, Ajax, JQuery, C, C++, Scala, HTML5, CSS3, SQL, Mysql, Nginx, Apache, Lighttpd, Linux, Ubuntu, Debian, Arch, Redhat, CentOS, Git, SVN, EC2, AWS, Matlab, Maya, Blender, Facebook Open Graph, Facebook Ads API, Lucene, Vim, Assembly, Android, OpenCL, Agile, Unit testing, TDD, OOP
